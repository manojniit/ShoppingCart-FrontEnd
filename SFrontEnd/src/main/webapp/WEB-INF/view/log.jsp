...
<br><br>
    ...
    <div class="row"> 
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            <h1  class = "text-primary",class="text-center login-title" >Sign in</h1>
            <div class="account-wall">
      
                <input type="text" class="form-control" placeholder="Email" required autofocus><br>
		<input type="password" class="form-control" placeholder="password" required autofocus><br>
            ...
            <a href="#" class="text-center new-account" style="color:blue">Create an account </a>
        </div>
    </div>
	<center><div>
<footer>
<p>2016 all copy rights are reserved</p>
</footer>
</div>
</center>
    ...
    <div>
      <div class="collapse navbar-collapse" id="myNavbar">
        ...
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" style = "color:white">footwear <span class="caret"></span></a>
          ...
          <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" style = "color:white">others<span class="caret"></span></a>
            <ul class="dropdown-menu">
